...
//  */
export let Messaging = (function (global) {
    ...
    function decodeMessage(input) {
        ...
        var wireMessage = new WireMessage(type, undefined);
        switch (type) {
    ...
    var Pinger = function (client, window, keepAliveInterval) {
        ...
        var pingReq = new WireMessage(MESSAGE_TYPE.PINGREQ, undefined).encode();
        ...
        var doPing = function () {
            if (!this.isReset) {
                ...
                this._client._disconnected(ERROR.PING_TIMEOUT.code, format(ERROR.PING_TIMEOUT, undefined));
            } else {
                this.isReset = false;
    ...
    ClientImpl.prototype.store = function (prefix, wireMessage) {
        var storedMessage: any = { type: wireMessage.type, messageIdentifier: wireMessage.messageIdentifier, version: 1 };
